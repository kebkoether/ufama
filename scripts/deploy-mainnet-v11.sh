...
# v1.1 shipped with Sushi's OLDER factory (CCRSMJDITH…GZGF), whose pools
# are stale — that broke unpinned pair resolution (fixed post-deploy via
# scripts/register-sushi-pairs.sh). Future deploys must use the live
# factory below, verified on-chain 2026-08-25.
